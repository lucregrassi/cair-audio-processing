...
log_dialogue_filename = "logs/client_dialogue_log_controlled_aggressive_tone.txt"
log_vision_filename = "logs/client_vision_log_controlled_aggressive_tone.txt"
